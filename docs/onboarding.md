...
Please note that this is only for native Linux, the rest of the WSL install process is found in the common section.
...
Git should not be necessary to install for WSL; it will most likely be preinstalled in WSL Ubuntu.
...
These keys should be added to Bitbucket to allow access to git upstream. They can be added to public keys in Bitwarden if you want.
