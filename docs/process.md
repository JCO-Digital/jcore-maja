...
A module's main branch should always be push protected, and all changes need to be done through pull-requests. Commits should be done using the [Conventional Commit](https://www.conventionalcommits.org) standard.
...
- Module versioning should follow semver, and commits should always follow the [Conventional Commit](https://www.conventionalcommits.org) standard.
...
- Modules should never be dependent on other modules, except JCORE-Ydin, which modules can freely depend on. (Locking the major version is highly encouraged)
- Do not require Timber in a module, if Timber is needed, require JCORE-Ydin and use the Timber version installed there.

# Theme development process

[JCORE 3 (Ilme)](https://github.com/jco-digital/jcore-ilme) is best developed using the development repo, as all projects use a copy of the latest version (branch).
